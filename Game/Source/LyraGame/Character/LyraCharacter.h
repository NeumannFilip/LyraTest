...
public:
	...
	//grabbing movement speed for character
	...
	//skeletal
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Lyra|Character")
	FORCEINLINE USkeletalMeshComponent* GetFirstPersonMesh() const {return MeshFirstPerson;}
...
public:
	...
	ULyraSettingsShared* GetLyraSettingsShared() const;

	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Lyra | Settings")
...
private:
	...
	UPROPERTY()
	ULyraSettingsShared* LyraSettingsShared;
