...
public:
	...
	// Creating me own inputactions
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Meta = (TitleProperty = "AdvancedInputAction"))
	TArray<FLyraInputAction> AdvancedAbilityInputActions;
};
