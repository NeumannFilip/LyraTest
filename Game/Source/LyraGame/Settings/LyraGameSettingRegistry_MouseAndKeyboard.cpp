...
UGameSettingCollection* ULyraGameSettingRegistry::InitializeMouseAndKeyboardSettings(ULyraLocalPlayer* InLocalPlayer)
{
	...
	////////////////////////////////////////////////////////////////////////////////////
	{
		...
		// Custom settings -> they will instantly get grabbed by GameSettingRegistry.
		//TODO(fn): togglers for sprints / aim etc
		//----------------------------------------------------------------------------------
		{
			UGameSettingValueDiscreteDynamic_Bool* Setting = NewObject<UGameSettingValueDiscreteDynamic_Bool>();
			Setting->SetDevName(TEXT("ToggleAim"));
			Setting->SetDisplayName(LOCTEXT("ToggleAim_Name", "Toggle Aim"));
			Setting->SetDescriptionRichText(LOCTEXT("ToggleAim_Description", "Enable aiming on toggle or hold."));

			Setting->SetDynamicGetter(GET_SHARED_SETTINGS_FUNCTION_PATH(GetToggleAim));
			Setting->SetDynamicSetter(GET_SHARED_SETTINGS_FUNCTION_PATH(SetToggleAim));
			Setting->SetDefaultValue(GetDefault<ULyraSettingsShared>()->GetToggleAim());
		...
		{
			UGameSettingValueDiscreteDynamic_Bool* Setting = NewObject<UGameSettingValueDiscreteDynamic_Bool>();
			Setting->SetDevName(TEXT("ToggleSprint"));
			Setting->SetDisplayName(LOCTEXT("ToggleSprint_Name", "Toggle Sprint"));
			Setting->SetDescriptionRichText(LOCTEXT("ToggleSprint_Description", "Enable sprint on toggle or hold."));

			Setting->SetDynamicGetter(GET_SHARED_SETTINGS_FUNCTION_PATH(GetToggleSprint));
			Setting->SetDynamicSetter(GET_SHARED_SETTINGS_FUNCTION_PATH(SetToggleSprint));
			Setting->SetDefaultValue(GetDefault<ULyraSettingsShared>()->GetToggleSprint());
