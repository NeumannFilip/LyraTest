...
public:
	...
	//Getters and setters for new settings from LyraGameSettingRegistry_MouseAndKeyboard class
	UFUNCTION()
	bool GetToggleAim() const { return bToggleAim; }
	UFUNCTION()
	void SetToggleAim(bool NewValue) { ChangeValueAndDirty(bToggleAim, NewValue); }

	UFUNCTION()
	bool GetToggleSprint () const { return bToggleSprint; }
	UFUNCTION()
	void SetToggleSprint(bool NewValue) { ChangeValueAndDirty(bToggleSprint, NewValue);  }
